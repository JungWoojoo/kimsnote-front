...
const GoogleCus = () => {
  ...
  const googleAuth = async () => {
    window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${process.env.REACT_APP_GOOGLE_CLIENT_ID}&redirect_uri=${process.env.REACT_APP_URL}/oauth2/redirect&response_type=code&scope=profile`
